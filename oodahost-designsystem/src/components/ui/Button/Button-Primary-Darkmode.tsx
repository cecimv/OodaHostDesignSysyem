...
export const ButtonPrimaryDarkmode = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ children, leftIcon, rightIcon, className = "", disabled = false, size = "md", variant = "primaryTextOnly", onClick, ...props }, ref) => {
    ...
    const variantClasses = {
        ...
        primaryLeftIcon: isPressed && variant === "primaryLeftIcon"
            ? "bg-[#177D50] text-[#04150D] focus:ring-[#E9FAF3]"
            : "bg-[#26D086] text-[#04150D] focus:ring-[#E9FAF3]",
        primaryRightIcon: isPressed && variant === "primaryRightIcon"
            ? "bg-[#177D50] text-[#04150D] focus:ring-[#E9FAF3]"
            : "bg-[#26D086] text-[#04150D] focus:ring-[#E9FAF3]",
        }

        const disabledClasses = "disabled:bg-[#2D2D2D] disabled:text-[#A4A4A4] disabled:cursor-not-allowed";
...
ButtonPrimaryDarkmode.displayName = "ButtonPrimaryDarkmode";